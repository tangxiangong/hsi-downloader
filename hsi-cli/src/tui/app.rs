...
use hsi_core::{
    AppConfig, DownloadHistory, DownloadTask, DownloaderEvent, Hsi, Priority, ProgressEvent,
    QueueEvent, TaskEvent, TaskStatus, config::AppTheme, parse_speed_limit, types::AddTaskOptions,
};
use tokio::sync::mpsc;
...
mod tests {
    ...
    use hsi_core::{AppConfig, TaskStatus};
